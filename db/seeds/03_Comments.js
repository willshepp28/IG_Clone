  ...
  return knex('comments').del()
    .then(function () {
      ...
      return knex('comments').insert([
        ...
        { post_id: 3, user_id: 2, user_comment: "I hate to bother you again, but would you mind sharing lol."},
        ...
        { post_id: 5, user_id: 4, user_comment: "@willshepp44 whatever you are such a douch lol"}
